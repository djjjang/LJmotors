import { X, Wrench, Shield, Check, Cpu, ExternalLink } from 'lucide-react';
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="pt-2 flex items-center gap-3">
            <button
              ...
              className="flex-1 py-3 rounded-lg bg-[#7e5700] text-white font-bold text-sm hover:bg-[#604100] transition-colors cursor-pointer text-center"
            >
              {brand.name} 정비 견적 및 예약 신청
            </button>
          </div>
        </div>
      </div>
